...
public class Context: DbContext
{
    ...
    /*
     * seeding : to test we pass json data to the table element 
     */
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<User>().HasData(new User()
        {
         ...
         CreatedOn = new DateTime(2024,05,01,13,28,22),
        });
    ...
    /*
     * since enum is stored as array index in the database as 0,1,2,but
     * We can convert enum to string such that the  UserType is stored as NONE,STUDENT, ADMIN
     */
